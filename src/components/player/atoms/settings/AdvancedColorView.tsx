    ...
    <>
      ...
      <Menu.Section>
        <div className="space-y-4 mt-3">
          <Slider
            label={t("settings.preferences.brightnessLabel", {
          ...
          <p className="text-xs text-type-secondary">
            Color adjustments are applied via CSS filters and persist across
            sessions. HDR and Dolby Vision content may still look incorrect —
            that is a browser/OS decoding limitation, not a player issue. Use
            these sliders to compensate.
          </p>
        </div>
      </Menu.Section>
    </>
